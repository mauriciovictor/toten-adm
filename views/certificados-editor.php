...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
    <div class="form-row">
        <div class="col-md-4 mb-3">
            <label for="validationCustom01">Titulo Certificado</label>
            <input type="text" value="<?php echo utf8_encode($certificado['nome_pt']);?>" class="form-control" name="nome_pt" id="validationCustom01" placeholder="Digite o titulo" required>
            <div class="valid-feedback">
                Tudo certo!
            </div>
        </div>
  ...
  <div class="form-row">
        <div class="col-md-4 mb-3">
            <label for="validationCustom01">Titulo Certificado</label>
            <input type="text" value="<?php echo utf8_encode($certificado['nome_en']);?>" class="form-control" id="validationCustom01" name="nome_en" placeholder="Digite o titulo" required>
            <div class="valid-feedback">
                Tudo certo!
            </div>
        </div>
...
<div class="form-row">
        <div class="col-md-4 mb-3">
            <div class="custom-file">
                <input type="file" name="pdf" class="custom-file-input" id="validationCustom03">
                <label class="custom-file-label" for="validationCustom03">Clique aqui para escolher o pdf</label>
                <div class="invalid-feedback">Arquivo Não Selecionado</div>
            </div>
        </div>
